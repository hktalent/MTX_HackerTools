...
{
	// /Users/xiatian/project/sfTester/javacode/com/mtx/safegene/test/xiatian/db/xtBigHackInfo.db
	 ...
	 * @return
	 */
	public static String getPatternStr(Pattern p, String s)
	{
		return IConst.getPatternStr(p,s);
	}
	 ...
	 * @return
	 */
	public static String getPatternStr(String p1, String s)
	{
		return IConst.getPatternStr2(p1,s);
	}
	/**
	 * 输出日志
	 * 
